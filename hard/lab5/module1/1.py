"""
Попробуйте изменить функцию активации (например, на relu)
и сравните результаты.
Какая функция активации лучше подходит для этой задачи?
"""
...
def run(activation, activation_deriv):
    EPOCHS = 100000
    LEARNING_RATE = 0.1
    HIDDEN_SIZE = 4
...
print("SIGMOID")
run(sigmoid, sigmoid_deriv)

print("LINEAR")
run(linear, linear_deriv)
